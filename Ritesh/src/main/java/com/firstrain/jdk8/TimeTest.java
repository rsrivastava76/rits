...
/*
		InstantFormatter formatter2 =InstantFormatter.ofPattern("MMM-d-yyyy HH:mm:ss");
        String input2="Jan-7-2002"+" 00:00:00";
    	Instant instantX = Instant.parse(input, formatter);
    	U.p(instantX+":00Z");
*/
	}
