...
public class U {
	...
	public static Map<String, String> getDocumentData(String siteDocId) {
		String dataUrl =
				Globals.TARGET_DSDOCSS_URL + "select?q=siteDocId%3A" + siteDocId + "&fl=title,dayId,insertTime,url&wt=json&indent=true";
		...
		} catch (Exception badDocs) {
			U.p("SOLR DSDOC PARSING ERROR: " + badDocs);
		}
		return docData;
	}
